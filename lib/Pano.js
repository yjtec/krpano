        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return (0, _AsyncLoadPano.loadPano)();
              ...
              case 2:
                ...
                krOptions = {
                  ...
                  swf: _defaultConfig.basepath + 'tour.swf',
                  consolelog: true,
                  basepath: _defaultConfig.basepath,
                  mobilescale: 1.0,
                ...
                kr.embedpano(_objectSpread({}, krOptions, {
                  onready: function onready(krpano) {
                    (0, _music.default)(krpano, musicBg, musicExplain);
...
var _default = function _default(props) {
  return _react.default.createElement(_AsyncLoadPano.AsyncLoadPano, null, _react.default.createElement(Pano, props));
};
